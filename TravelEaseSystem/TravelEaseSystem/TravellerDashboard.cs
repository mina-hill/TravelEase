...
namespace TravelEaseSystem
{
    public partial class TravellerDashboard: Form
    {
        ...
        {
            btnTrips.BackColor = Color.DarkOliveGreen;  // Example hover color
            btnTrips.ForeColor = Color.White;
        }

        private void btnTrips_MouseLeave(object sender, EventArgs e)
        {
            btnTrips.BackColor = Color.Beige;  // Original color
            btnTrips.ForeColor = Color.Black;
        }


        private void TravellerDashboard_Load(object sender, EventArgs e)
        {
        ...
        private void tripBookingImg_Click(object sender, EventArgs e)
        {
        ...
        private void ItineraryTableLayoutPanel_Paint(object sender, PaintEventArgs e)
        {
